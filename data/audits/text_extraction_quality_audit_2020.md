...
**Last updated:** 2026-06-09 — Phase 0 complete: Checks A/B/C done; Block B, n_material_topics_a, and language detection populated (`phase0_2020.py`); 39 mojibake-risk files identified; see Acceptance Summary  
...
| 0.7 | Extract `n_material_topics_a` from `gri_codes_summary_2020.csv` | data-analyst | ✅ Done | `phase0_2020.py` (2026-06-09). 404-row summary → 400 DB rows matched; 227 with n_material_topics_a > 0. 177 rows have 0 (no codes or not in summary). |
