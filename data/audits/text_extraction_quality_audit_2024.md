...
| # | Step | Owner | Status | Notes |
|---|---|---|---|---|
| 2.1 | BGE-M3 multilingual semantic topic matcher (Chinese/bilingual) | technical-researcher | ✅ Done (2026-06-09) | Script: `phase2_step2_1_bge_2024.py`. 361/361 (100%) fill. bge_top1_sim mean=0.690; bge_mean_sim=0.660. Top topics: GRI Alignment (122), Stakeholder Engagement (56), Training & Education (25), TCFD/ISSB Alignment (20). Affinities: gov=0.353, soc=0.295, env=0.173. JSONL: bge_2024_matches.jsonl. DB now 188 cols. |
| 2.2 | XLM-RoBERTa-XNLI zero-shot ESG classifier (Chinese/bilingual) | technical-researcher | ✅ Done (2026-06-09) | Script: `phase2_step2_2_xlmr_2024.py`. 361/361 (100%) fill. dominant: soc=294 (81.4%), other=44 (12.2%), gov=14 (3.9%), env=9 (2.5%). Mean pcts: soc=0.449, gov=0.204, other=0.213, env=0.164. Mean sentences=43.9. Strongly soc-dominant vs English-track gov-dominant (FinBERT: gov=51.5%). |
