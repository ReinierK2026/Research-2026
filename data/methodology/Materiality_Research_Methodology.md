...
**Column count history:** 157 (original) → 175 (+18 NLP Phase 1) → 188 (+13 NLP Phase 2) → 190 (+2 Phase 3) → 192 (+language_track, impact_intensity) → 195 (+twse_cgq_score, has_any_assurance, big4_assurance, big4_financial_auditor) → **202** (+7 Block E: jaccard_similarity, topic_churn_rate, topics_added_n, topics_dropped_n, net_topic_change, topics_added_codes, topics_dropped_codes)
...
| **DiD window (full)** | `data/db_did_full.csv` | **3,283 × 202** | 2020–2024 | Primary analytical file; all cohorts retained; g=2024 contributes controls |
| **DiD core** | `data/db_did.csv` | **2,960 × 202** | 2020–2024 | g=2024 excluded entirely; use only with `glist=c(2021,2022)` |
