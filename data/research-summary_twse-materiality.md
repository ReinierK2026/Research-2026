...
### Database State (current — Pass DB-07, 2026-06-23)
- Rows: **5,408** (data) + 2 header rows (FY 2016–2024)
- Columns: **202** (Pass DB-07: +7 Block E topic dynamics cols 196–202)
- Encoding: UTF-8-sig BOM
- Full universe: 2,091 unique companies × 2016–2024
- Analytical sample (FY ≥ 2020): 3,283 rows; db_did_full.csv = 3,283 × 202 cols; db_did.csv = 2,960 × 202 cols (g=2024 excluded)
...
| 2026-06-22 | coordinator | DB-01 | **rd_intensity patch**: 85 rows with rd_expense=0 and revenue>0 corrected (genuine zero-R&D firms). `rd_dummy` computed for 2022–2024 (was erroneously all-zero). 279 null rows remain (no revenue or rd_expense; dropped by model). |
| 2026-06-22 | coordinator | DB-02 | **Board diversity integrated** from TEJ Board diversity.xlsx: 2,774/2,856 rows updated; `independent_director_ratio` now 97.7% for 2021–2024 (was 0%); 5 new cols added. |
| 2026-06-22 | coordinator | DB-03 | **n_material_topics_b zeros→NA**: zeros were unprocessed placeholders, not genuine zero-topic rows. `n_material_topics_a` confirmed 100% identical to `n_material_topics_b` (r=1.000); dropped from primary analysis. |
